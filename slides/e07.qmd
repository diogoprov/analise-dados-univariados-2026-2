...
## Cinco formas comuns em ecologia
...
filogenética, isso é PGLS ou modelo misto filogenético — no `glmmTMB`, a
estrutura `propto()`, que veremos no Encontro 8.
:::
...
tibble(Beach = sep$Beach, n = sep$n, separado = sep$intercepto, misto = misto) |>
  ...
  geom_point(size = 3) +
  scale_colour_manual(values = c("#96661f", "#1c6e8c"),
...
## As saídas {.smaller .tabela-grande}
