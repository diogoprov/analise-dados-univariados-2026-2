...
1. Para testar o efeito de uma dieta sobre o peso, **um** rato é pesado
   todos os dias durante trinta dias. *n* = 30?
2. Para comparar duas espécies de formiga, coletam-se cinquenta operárias
   de **um** formigueiro de cada espécie. *n* = 50 por espécie?
3. Para comparar a herbivoria entre duas florestas, medem-se cem folhas de
   **uma** árvore em cada floresta. *n* = 100 por floresta?
