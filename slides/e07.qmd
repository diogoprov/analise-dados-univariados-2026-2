...
Gomes (2022) simulou exatamente esse caso e a resposta tem duas partes.

::: {.definicao}
Com poucos níveis, as estimativas dos **efeitos fixos** e a incerteza em
torno delas quase não mudam — a cobertura do intervalo depende do
**tamanho amostral**, não do número de níveis. O que de fato piora é a
variância do efeito aleatório, e os ajustes singulares ficam mais
frequentes.
:::

Ou seja: se o agrupamento entra só para acomodar a dependência — um
*nuisance* — e a inferência é sobre os efeitos fixos, menos de cinco
níveis pode ser aceitável. Se a variância entre grupos **é** a sua
pergunta, a regra continua valendo.

::: {.nota}
Gomes, D.G.E. 2022. [Should I use fixed effects or random effects when I
have fewer than five levels of a grouping factor in a mixed-effects
model?](https://doi.org/10.7717/peerj.12794) *PeerJ* 10:e12794. Nos
cenários de amostra pequena (*n* = 30) o autor encontra perda de
desempenho, e fecha pedindo mais simulações antes de generalizar.
:::
