...
## Primeiro, a tabela de códigos {.tabela-grande}
...
## A matriz, uma linha de cada espécie
...
## Três erros com nome {.tabela-grande}
...
::: {.nota}
- Quinn, G.P. & Keough, M.J. 2023. [Linear Models for Crossed (Factorial) Designs](https://doi.org/10.1017/9781139568173.008), cap. 7, e a seção 8.2 (ANCOVA) de [Multiple Regression Models](https://doi.org/10.1017/9781139568173.009), cap. 8. Em *Experimental Design and Data Analysis for Biologists*, 2ª ed. Cambridge University Press.
